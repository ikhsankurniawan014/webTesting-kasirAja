...
WebUI.setText(findTestObject('Object Repository/Fitur Onboarding/Daftar/input_nama toko_name'), namaToko)

WebUI.setText(findTestObject('Object Repository/Fitur Onboarding/Daftar/input_email_email'), email)

WebUI.setText(findTestObject('Object Repository/Fitur Onboarding/Daftar/input_password_password'), password)
