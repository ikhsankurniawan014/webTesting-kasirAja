...
WebUI.setText(findTestObject('Fitur Onboarding/Login/input_email_email'), 'testingkatalon')
...
WebUI.verifyElementPresent(findTestObject('Fitur Onboarding/Login/div_email must be a valid email'), 0)
