...
WebUI.setText(findTestObject('Object Repository/Fitur Onboarding/Daftar/input_email_email'), 'testkatalon')
...
WebUI.verifyElementPresent(findTestObject('Fitur Onboarding/Daftar/alert email tidak valid'), 60)
